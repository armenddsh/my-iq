...
- [ ] Task: Initialize Next.js project with TypeScript, Tailwind, and GitHub Pages static export config
...
- [ ] Task: Define Question type and create 30-question dataset
...
- [ ] Task: Implement scoring, localStorage persistence, and timer utilities
...
- [ ] Task: Build QuestionCard, ProgressBar, Timer, ScoreDisplay, and AdSlot components
...
- [ ] Task: Build test page with enforced timer and navigation
...
- [ ] Task: Build results page with score and answer explanations
...
- [ ] Task: Add Google AdSense and analytics integration
...
- [ ] Task: Add Vitest unit and component tests
...
- [ ] Task: Add Playwright E2E test for full test flow
...
- [ ] Task: Configure GitHub Pages deployment and verify production build
